...
echo [2/4] Empaquetando exe (PyInstaller)...
pyinstaller --noconfirm --clean --log-level WARN --windowed --name PureLauncher --icon assets\icon.ico --add-data "ui;ui" main.py || goto :error
