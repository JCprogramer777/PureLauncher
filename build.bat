...
echo [2b/4] Empaquetando herramienta de restauracion (Restaurar.exe)...
pyinstaller --noconfirm --clean --log-level WARN --windowed --onefile --name Restaurar --icon assets\icon.ico restore.py || goto :error
